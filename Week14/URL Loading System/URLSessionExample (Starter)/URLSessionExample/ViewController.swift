...
//    }
  ...
  @IBAction private func sessionConfig(_ sender: Any) {
    ...
    let sessionConfig = URLSessionConfiguration.default
     ...
     // default 값이 true / wifi 로만 데이터를 다운로드 하게 할 것인지
    ...
    // 16KB (16 * 1024 = 16384 )   256MB (256 * 1024 * 1024 = 268435356)
    let myCache = URLCache(memoryCapacity: 16_384, diskCapacity: 268_435_356, diskPath: nil)
    sessionConfig.urlCache = myCache
    print("my :",myCache.diskCapacity)
    print("my :",myCache.currentDiskUsage)
