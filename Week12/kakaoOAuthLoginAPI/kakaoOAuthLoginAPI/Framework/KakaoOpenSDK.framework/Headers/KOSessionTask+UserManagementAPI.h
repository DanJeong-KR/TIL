...
typedef void (^KOSessionTaskServiceTermsCompletionHandler)(KOUserServiceTerms *userServiceTerms, NSError *error);
...
/*!
 ...
 @param completionHandler 요청 완료시 실행될 핸들러.
 */
+ (instancetype)shippingAddressTaskWithCompletionHandler:(void (^)(KOUserShippingAddress *userShippingAddress, NSError *error))completionHandler;
...
/*!
 ...
 @param completionHandler 요청 완료시 실행될 핸들러.
 */
+ (instancetype)shippingAddressTaskWithAddressId:(NSString * _Nullable )shippingAddressId
                               completionHandler:(void (^)(KOUserShippingAddress *userShippingAddress, NSError *error))completionHandler;
...
/*!
 ...
 @param completionHandler 요청 완료시 실행될 핸들러.
 */
+ (instancetype)shippingAddressTaskWithFromUpdatedAt:(NSDate * _Nullable )fromUpdatedAt
